    ...
    <nav class="navbar">
        ...
        <div class="navbar-brand">
            ...
            <img
                ...
                style="width: 38px; height: 38px; object-fit: contain; border-radius: 10px; background: rgba(255,255,255,0.08); padding: 4px;"
            >
                    ...
                    <div class="cobro-info">
                        ...
                        <div>
                            ...
                            <span class="cliente-name">
                                {{ $cobro->nombre_cliente }}
                            </span>

                            <span class="cliente-phone">
                                ({{ $cobro->telefono }})
                            </span>
                        ...
                        @if($cobro->tipo_registro === 'mano_obra')
                            ...
                            @else
                                ...
                                <span class="badge badge-danger">
                                    ...
                                    ({{ $cobro->motivo_no_realizado ?? 'Sin motivo' }})
                                </span>
